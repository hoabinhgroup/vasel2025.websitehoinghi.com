! function(e) {
		...
		var r = function() {
			...
			return t = e, r = [{
				...
				value: function(e) {
					...
					var t = "/" !== LOUIS_MEDIA_URL.base_url.substr(-1, 1) ? LOUIS_MEDIA_URL.base_url + "/" : LOUIS_MEDIA_URL.base_url;
					return "/" === e.substring(0, 1) ? t + e.substring(1) : t + e
				}
			}, {
				key: "showAjaxLoading",
				value: function() {
					var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : $(".louis-media-main");
					e.addClass("on-loading").append($("#louis_media_loading").html())
				}
			}, {
				key: "hideAjaxLoading",
				value: function() {
				...
				key: "isOnAjaxLoading",
				value: function() {
					var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : $(".louis-media-items");
				...
				value: function() {
					return window.louisMedia.options && "modal" === window.louisMedia.options.open_in ? $.extend(!0, i.a.request_params, window.louisMedia.options || {}) : i.a.request_params
				}
			}, {
				key: "setSelectedFile",
				value: function(e) {
					void 0 !== window.louisMedia.options ? window.louisMedia.options.selected_file_id = e : i.a.request_params.selected_file_id = e
				}
			}, {
				key: "getConfigs",
				value: function() {
				...
				key: "isUseInModal",
				value: function() {
					return "select-files" === e.getUrlParam("media-action") || window.louisMedia && window.louisMedia.options && "modal" === window.louisMedia.options.open_in
				}
			}, {
				key: "resetPagination",
				value: function() {
					LOUIS_MEDIA_CONFIG.pagination = {
						paged: 1,
						posts_per_page: 40,
	...
	125: function(e, t, a) {
		...
		var l = function() {
			...
			d = function e(t, a) {
				o(this, e), window.louisMedia = window.louisMedia || {};
				var s = $("body");
				a = $.extend(!0, {
					multiple: !0,
					type: "*",
				...
				var l = function(e) {
					...
					$("#louis_media_modal").modal(), window.louisMedia.options = a, window.louisMedia.options.open_in = "modal", window.louisMedia.$el = t, n.a.request_params.filter = "everything", i.a.storeConfig();
					var o = window.louisMedia.$el.data("louis-media");
					void 0 !== o && o.length > 0 && (o = o[0], window.louisMedia.options = $.extend(!0, window.louisMedia.options, o || {}), void 0 !== o.selected_file_id ? window.louisMedia.options.is_popup = !0 : void 0 !== window.louisMedia.options.is_popup && (window.louisMedia.options.is_popup = void 0)), 0 === $("#louis_media_body .louis-media-container").length ? $("#louis_media_body").load(LOUIS_MEDIA_URL.popup, function(e) {
						e.error && alert(e.message), $("#louis_media_body").removeClass("media-modal-loading").closest(".modal-content").removeClass("bb-loading"), $(document).find(".louis-media-container .js-change-action[data-type=refresh]").trigger("click"), r.a.destroyContext(), r.a.initContext()
					}) : $(document).find(".louis-media-container .js-change-action[data-type=refresh]").trigger("click")
				};
				"string" == typeof t ? s.off("click", t).on("click", t, l) : t.off("click").on("click", l)
			};
		window.louisMediaStandAlone = d, $(".js-insert-to-editor").off("click").on("click", function(e) {
			e.preventDefault();
			var t = i.a.getSelectedFiles();
			_.size(t) > 0 && l.editorSelectFile(t)
		}), $.fn.louisMedia = function(e) {
			var t = $(this);
	...
	308: function(e, t, a) {
		...
		var d = function() {
			function e() {
				! function(e, t) {
					if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
				}(this, e), this.group = {}, this.group.list = $("#louis_media_items_list").html(), this.group.tiles = $("#louis_media_items_tiles").html(), this.item = {}, this.item.list = $("#louis_media_items_list_element").html(), this.item.tiles = $("#louis_media_items_tiles_element").html(), this.$groupContainer = $(".louis-media-items")
			}
			var t, a, i;
			return t = e, (a = [{
				key: "renderData",
				value: function(e) {
					...
					_.includes(["all_media", "public", "trash", "favorites", "recent"], l) || (l = "all_media"), s = s.replace(/__noItemIcon__/gi, LOUIS_MEDIA_CONFIG.translations.no_item[l].icon || "").replace(/__noItemTitle__/gi, LOUIS_MEDIA_CONFIG.translations.no_item[l].title || "").replace(/__noItemMessage__/gi, LOUIS_MEDIA_CONFIG.translations.no_item[l].message || "");
					var d = $(s),
						c = d.find("ul");
					a && this.$groupContainer.find(".louis-media-grid ul").length > 0 && (c = this.$groupContainer.find(".louis-media-grid ul")), _.size(e.folders) > 0 || _.size(e.files) > 0 || a ? $(".louis-media-items").addClass("has-items") : $(".louis-media-items").removeClass("has-items"), _.forEach(e.folders, function(e) {
					...
					}), !1 !== t && i.$groupContainer.empty(), a && this.$groupContainer.find(".louis-media-grid ul").length > 0 || i.$groupContainer.append(d), i.$groupContainer.find(".loading-wrapper").remove(), o.a.handleDropdown(), $(".js-media-list-title[data-id=" + e.selected_file_id + "]").trigger("click")
				}
		...
		var u = function() {
			function e() {
				! function(e, t) {
					if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
				}(this, e), this.$detailsWrapper = $(".louis-media-main .louis-media-details"), this.descriptionItemTemplate = '<div class="louis-media-name"><p>__title__</p>__url__</div>', this.onlyFields = ["name", "full_url", "size", "mime_type", "created_at", "updated_at", "nothing_selected"]
			}
			var t, a, i;
			return t = e, (a = [{
				key: "renderData",
				value: function(e) {
					var t = this,
						...
						o = !1;
					_.forEach(e, function(e, t) {
						_.includes(a.onlyFields, t) && (_.includes(["size", "mime_type"], t) || (r += a.descriptionItemTemplate.replace(/__title__/gi, LOUIS_MEDIA_CONFIG.translations[t]).replace(/__url__/gi, e ? "full_url" === t ? '<div class="input-group"><input id="file_details_url" type="text" value="' + e + '" class="form-control"><span class="input-group-prepend"><button class="btn btn-default js-btn-copy-to-clipboard" type="button" data-clipboard-target="#file_details_url" title="Copied"><img class="clippy" src="' + n.a.asset("/vendor/core/modules/media/images/clippy.svg") + '" width="13" alt="Copy to clipboard"></button></span></div>' : '<span title="' + e + '">' + e + "</span>" : ""), "full_url" === t && (o = !0)))
					}), a.$detailsWrapper.find(".louis-media-thumbnail").html(i), a.$detailsWrapper.find(".louis-media-description").html(r), o && (new Clipboard(".js-btn-copy-to-clipboard"), $(".js-btn-copy-to-clipboard").tooltip().on("mouseenter", function() {
						$(t).tooltip("hide")
		...
		var p = function() {
			function e() {
				! function(e, t) {
					if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
				}(this, e), this.MediaList = new d, this.MediaDetails = new u, this.breadcrumbTemplate = $("#louis_media_breadcrumb_item").html()
			}
			var t, a, l;
			return t = e, l = [{
				key: "refreshFilter",
				value: function() {
					var e = $(".louis-media-container"),
						t = n.a.getRequestParams().view_in;
					"all_media" === t || n.a.getRequestParams().folder_id ? ($('.louis-media-actions .btn:not([data-type="refresh"]):not(label)').removeClass("disabled"), e.attr("data-allow-upload", "true")) : ($('.louis-media-actions .btn:not([data-type="refresh"]):not(label)').addClass("disabled"), e.attr("data-allow-upload", "false")), $(".louis-media-actions .btn.js-louis-media-change-filter-group").removeClass("disabled");
					var a = $('.louis-media-actions .btn[data-action="empty_trash"]');
				...
				value: function() {
					...
					if (void 0 !== LOUIS_MEDIA_CONFIG.pagination) {
						if (LOUIS_MEDIA_CONFIG.pagination.in_process_get_media) return;
						LOUIS_MEDIA_CONFIG.pagination.in_process_get_media = !0
					}
					var l = this;
					l.getFileDetails({
						icon: "far fa-image",
					...
					"recent" === d.view_in && (d.recent_items = i.b), d.is_popup = !0 === a || void 0, d.onSelectFiles = void 0, void 0 !== d.search && "" != d.search && void 0 !== d.selected_file_id && (d.selected_file_id = void 0), d.load_more_file = s, void 0 !== LOUIS_MEDIA_CONFIG.pagination && (d.paged = LOUIS_MEDIA_CONFIG.pagination.paged, d.posts_per_page = LOUIS_MEDIA_CONFIG.pagination.posts_per_page), $.ajax({
						url: LOUIS_MEDIA_URL.get_media,
						type: "GET",
						data: d,
						dataType: "json",
						beforeSend: function() {
						...
						success: function(a) {
							console.log({a});
							l.MediaList.renderData(a.data, t, s), l.renderBreadcrumbs(a.data.breadcrumbs), e.refreshFilter(), o.a.renderActions(), void 0 !== LOUIS_MEDIA_CONFIG.pagination && (void 0 !== LOUIS_MEDIA_CONFIG.pagination.paged && (LOUIS_MEDIA_CONFIG.pagination.paged += 1), void 0 !== LOUIS_MEDIA_CONFIG.pagination.in_process_get_media && (LOUIS_MEDIA_CONFIG.pagination.in_process_get_media = !1), void 0 !== LOUIS_MEDIA_CONFIG.pagination.posts_per_page && a.data.files.length + a.data.folders.length < LOUIS_MEDIA_CONFIG.pagination.posts_per_page && void 0 !== LOUIS_MEDIA_CONFIG.pagination.has_more && (LOUIS_MEDIA_CONFIG.pagination.has_more = !1))
						},
						complete: function() {
							n.a.hideAjaxLoading()
						},
						error: function(e) {
							console.log('LOUIS_MEDIA_URL.get_media error:', e);
							r.a.handleError(e)
						}
					})
				}
				...
				value: function(e) {
					var t = this,
						a = $(".louis-media-breadcrumb .breadcrumb");
					...
					}), $(".louis-media-container").attr("data-breadcrumb-count", _.size(e))
				}
		...
		var m = function() {
			...
			return t = e, o = [{
				...
				value: function(t) {
					var a = this;
					$.ajax({
						url: LOUIS_MEDIA_URL.create_folder,
						type: "POST",
						data: {
						...
						success: function(t) {
							t.error ? r.a.showMessage("error", t.message, LOUIS_MEDIA_CONFIG.translations.message.error_header) : (r.a.showMessage("success", t.message, LOUIS_MEDIA_CONFIG.translations.message.success_header), n.a.resetPagination(), a.MediaService.getMedia(!0), e.closeModal())
						},
						complete: function() {
							n.a.hideAjaxLoading()
						},
		...
		var g = function() {
				function e() {
					! function(e, t) {
						if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
					}(this, e), this.$body = $("body"), this.dropZone = null, this.uploadUrl = LOUIS_MEDIA_URL.upload_file, this.uploadProgressBox = $(".louis-upload-progress"), this.uploadProgressContainer = $(".louis-upload-progress .louis-upload-progress-table"), this.uploadProgressTemplate = $("#louis_media_upload_progress_item").html(), this.totalQueued = 1, this.MediaService = new p, this.totalError = 0
				}
				var t, a, i;
				return t = e, i = [{
					key: "formatFileSize",
					...
					key: "init",
					value: function() {
						_.includes(LOUIS_MEDIA_CONFIG.permissions, "files.create") && $(".louis-media-items").length > 0 && this.setupDropZone(), this.handleEvents()
					}
				}, {
					key: "setupDropZone",
					value: function() {
						var e = this;
						e.dropZone = new Dropzone(document.querySelector(".louis-media-items"), {
							url: e.uploadUrl,
							thumbnailWidth: !1,
							thumbnailHeight: !1,
							parallelUploads: 1,
							...
							n.a.resetPagination(), e.MediaService.getMedia(!0), 0 === e.totalError && setTimeout(function() {
								$(".louis-upload-progress .close-pane").trigger("click")
							}, 5e3)
						})
					}
				}, {
					...
					value: function() {
						var e = this;
						e.$body.off("click", ".louis-upload-progress .close-pane").on("click", ".louis-upload-progress .close-pane", function(t) {
							t.preventDefault(), $(".louis-upload-progress").addClass("hide-the-pane"), e.totalError = 0, setTimeout(function() {
								$(".louis-upload-progress li").remove(), e.totalQueued = 1
							}, 300)
						})
					}
				}, {
		...
		var w = function() {
			...
			return t = e, r = [{
				...
				key: "setupLayout",
				value: function() {
					var e = $('.js-louis-media-change-filter[data-type="filter"][data-value="' + n.a.getRequestParams().filter + '"]');
					e.closest("li").addClass("active").closest(".dropdown").find(".js-louis-media-filter-current").html("(" + e.html() + ")");
					var t = $('.js-louis-media-change-filter[data-type="view_in"][data-value="' + n.a.getRequestParams().view_in + '"]');
					t.closest("li").addClass("active").closest(".dropdown").find(".js-louis-media-filter-current").html("(" + t.html() + ")"), n.a.isUseInModal() && $(".louis-media-footer").removeClass("hidden"), $('.js-louis-media-change-filter[data-type="sort_by"][data-value="' + n.a.getRequestParams().sort_by + '"]').closest("li").addClass("active");
					var a = $("#media_details_collapse");
					a.prop("checked", i.a.hide_details_pane || !1), setTimeout(function() {
						$(".louis-media-details").removeClass("hidden")
				...
				value: function() {
					...
					$(document).on("keyup keydown", function(e) {
						...
						if (i) {
							...
							if (l) {
								var d = l.index_key,
									c = s.index();
								$(".louis-media-items li").each(function(e, t) {
									e > d && e <= c && $(t).find("input[type=checkbox]").prop("checked", !0)
								})
							}
						} else t || a || s.closest(".louis-media-items").find("input[type=checkbox]").prop("checked", !1);
						...
						e.preventDefault();
						var t = $(".louis-media-breadcrumb .breadcrumb li").length;
						$(".louis-media-breadcrumb .breadcrumb li:nth-child(" + (t - 1) + ") a").trigger("click")
					...
					}).on("click contextmenu", ".louis-media-items", function(t) {
						_.size(t.target.closest(".js-context-menu")) || ($('.louis-media-items input[type="checkbox"]').prop("checked", !1), $(".louis-dropdown-actions").addClass("disabled"), e.MediaService.getFileDetails({
							icon: "far fa-image",
							nothing_selected: ""
						}))
					})
				...
				value: function() {
					var e = this;
					e.$body.off("click", ".js-louis-media-change-view-type .btn").on("click", ".js-louis-media-change-view-type .btn", function(t) {
						t.preventDefault();
						var a = $(t.currentTarget);
						a.hasClass("active") || (a.closest(".js-louis-media-change-view-type").find(".btn").removeClass("active"), a.addClass("active"), i.a.request_params.view_type = a.data("type"), "trash" === a.data("type") ? $(document).find(".js-insert-to-editor").prop("disabled", !0) : $(document).find(".js-insert-to-editor").prop("disabled", !1), n.a.storeConfig(), void 0 !== LOUIS_MEDIA_CONFIG.pagination && void 0 !== LOUIS_MEDIA_CONFIG.pagination.paged && (LOUIS_MEDIA_CONFIG.pagination.paged = 1), e.MediaService.getMedia(!0, !1))
					}), $('.js-louis-media-change-view-type .btn[data-type="' + n.a.getRequestParams().view_type + '"]').trigger("click"), this.bindIntegrateModalEvents()
				}
			}, {
				key: "changeFilter",
				value: function() {
					var e = this;
					e.$body.off("click", ".js-louis-media-change-filter").on("click", ".js-louis-media-change-filter", function(t) {
						if (t.preventDefault(), !n.a.isOnAjaxLoading()) {
							var a = $(t.currentTarget),
								r = a.closest("ul"),
								o = a.data();
							i.a.request_params[o.type] = o.value, "view_in" === o.type && (i.a.request_params.folder_id = 0, "trash" === o.value ? $(document).find(".js-insert-to-editor").prop("disabled", !0) : $(document).find(".js-insert-to-editor").prop("disabled", !1)), a.closest(".dropdown").find(".js-louis-media-filter-current").html("(" + a.html() + ")"), n.a.storeConfig(), p.refreshFilter(), n.a.resetPagination(), e.MediaService.getMedia(!0), r.find("> li").removeClass("active"), a.closest("li").addClass("active")
						}
					})
				}
			}, {
				...
				value: function() {
					var e = this;
					e.$body.off("click", '.louis-media-actions .js-change-action[data-type="refresh"]').on("click", '.louis-media-actions .js-change-action[data-type="refresh"]', function(t) {
						t.preventDefault(), n.a.resetPagination();
						var a = void 0 !== window.louisMedia.$el ? window.louisMedia.$el.data("louis-media") : void 0;
						void 0 !== a && a.length > 0 && void 0 !== a[0].selected_file_id ? e.MediaService.getMedia(!0, !0) : e.MediaService.getMedia(!0, !1)
					}).off("click", ".louis-media-items li.no-items").on("click", ".louis-media-items li.no-items", function(e) {
						e.preventDefault(), $(".louis-media-header .louis-media-top-header .louis-media-actions .js-dropzone-upload").trigger("click")
				...
				value: function() {
					...
					}), e.$body.off("submit", "#modal_empty_trash .louis-form").on("submit", "#modal_empty_trash .louis-form", function(t) {
						t.preventDefault();
						var a = $(t.currentTarget);
						o.a.processAction({
				...
				value: function(e) {
					if (void 0 !== window.louisMedia.$el) {
						var t = _.first(e),
							a = window.louisMedia.$el.data("louis-media");
				...
				value: function() {
					var e = $("#louis_media_modal"),
						t = this;
					e.off("click", ".js-insert-to-editor").on("click", ".js-insert-to-editor", function(a) {
						a.preventDefault();
						var i = n.a.getSelectedFiles();
						console.log('bindIntegrateModalEvents', i);
						_.size(i) > 0 && (window.louisMedia.options.onSelectFiles(i, window.louisMedia.$el), t.checkFileTypeSelect(i) && e.find(".close").trigger("click"))
				...
				value: function() {
					var e = this;
					$(".louis-media-main .louis-media-items").bind("DOMMouseScroll mousewheel", function(t) {
						(t.originalEvent.detail > 0 || t.originalEvent.wheelDelta < 0) && (($(t.currentTarget).closest(".media-modal").length > 0 ? $(t.currentTarget).scrollTop() + $(t.currentTarget).innerHeight() / 2 >= $(t.currentTarget)[0].scrollHeight - 450 : $(t.currentTarget).scrollTop() + $(t.currentTarget).innerHeight() >= $(t.currentTarget)[0].scrollHeight - 150) && void 0 !== LOUIS_MEDIA_CONFIG.pagination && LOUIS_MEDIA_CONFIG.pagination.has_more && e.MediaService.getMedia(!1, !1, !0))
					})
				}
			}]) && b(t.prototype, a), r && b(t, r), e
		}();
		$(document).ready(function() {
			window.louisMedia = window.louisMedia || {}, w.setupSecurity(), (new w).init()
		})
	},
	35: function(e, t, a) {
		"use strict";
		...
		var o = function() {
			...
			return t = e, o = [{
				...
				value: function() {
						...
						_.each(t, function(t) {
							e[t.action] = {
								...
								icon: function(e, i, n, r) {
									return i.html('<i class="' + t.icon + '" aria-hidden="true"></i> ' + (LOUIS_MEDIA_CONFIG.translations.actions_list[a][t.action] || r.name)), "context-menu-icon-updated"
								},
								callback: function() {
					...
					_.each(t, function(t) {
						e[t] = void 0
					}), n.a.getSelectedFolder().length > 0 && (e.preview = void 0, e.copy_link = void 0, _.includes(LOUIS_MEDIA_CONFIG.permissions, "folders.create") || (e.make_copy = void 0), _.includes(LOUIS_MEDIA_CONFIG.permissions, "folders.edit") || (e.rename = void 0), _.includes(LOUIS_MEDIA_CONFIG.permissions, "folders.trash") || (e.trash = void 0, e.restore = void 0), _.includes(LOUIS_MEDIA_CONFIG.permissions, "folders.destroy") || (e.delete = void 0), _.includes(LOUIS_MEDIA_CONFIG.permissions, "folders.favorite") || (e.favorite = void 0, e.remove_favorite = void 0));
					var a = n.a.getSelectedFiles();
					a.length > 0 && (_.includes(LOUIS_MEDIA_CONFIG.permissions, "files.create") || (e.make_copy = void 0), _.includes(LOUIS_MEDIA_CONFIG.permissions, "files.edit") || (e.rename = void 0), _.includes(LOUIS_MEDIA_CONFIG.permissions, "files.trash") || (e.trash = void 0, e.restore = void 0), _.includes(LOUIS_MEDIA_CONFIG.permissions, "files.destroy") || (e.delete = void 0), _.includes(LOUIS_MEDIA_CONFIG.permissions, "files.favorite") || (e.favorite = void 0, e.remove_favorite = void 0));
					var r = !1;
			...
			n = {
				...
				actions_list: {
					...
					file: [{
						...
						action: "copy_link",
						order: 0,
						class: "louis-action-copy-link"
					}, {
						icon: "far fa-edit",
						name: "Rename",
						action: "rename",
						order: 1,
						class: "louis-action-rename"
					}, {
						icon: "fa fa-copy",
						name: "Make a copy",
						action: "make_copy",
						order: 2,
						class: "louis-action-make-copy"
					}],
					user: [{
						icon: "fa fa-star",
						name: "Favorite",
					...
					other: [{
						...
						action: "download",
						order: 0,
						class: "louis-action-download"
					}, {
						icon: "fa fa-trash",
						name: "Move to trash",
						action: "trash",
						order: 1,
						class: "louis-action-trash"
					}, {
						icon: "fa fa-eraser",
						name: "Delete permanently",
						action: "delete",
						order: 2,
						class: "louis-action-delete"
					}, {
						icon: "fa fa-undo",
						name: "Restore",
						action: "restore",
						order: 3,
						class: "louis-action-restore"
					}]
				}
			};
		...
		var n = function() {
			...
			return t = e, n = [{
				...
				value: function(e, t) {
					...
					switch (e) {
						case "error":
							a = LOUIS_MEDIA_CONFIG.translations.message.error_header;
							break;
						case "success":
							a = LOUIS_MEDIA_CONFIG.translations.message.success_header
					}
					toastr[e](t, a)
				}
			}, {
		...
		var s = function() {
			...
			return t = e, s = [{
				...
				value: function() {
					...
					e.renderActions(), t > 0 ? $(".louis-dropdown-actions").removeClass("disabled") : $(".louis-dropdown-actions").addClass("disabled")
				}
			}, {
				key: "handlePreview",
				value: function() {
				...
				value: function() {
					...
					var t = $(".js-louis-clipboard-temp");
					t.data("clipboard-text", e), new Clipboard(".js-louis-clipboard-temp", {
						text: function() {
							return e
						}
					}), r.a.showMessage("success", LOUIS_MEDIA_CONFIG.translations.clipboard.success, LOUIS_MEDIA_CONFIG.translations.message.success_header), t.trigger("click")
				}
			}, {
				...
				value: function(t, a) {
					...
					switch (_.each(n.a.getSelectedItems(), function(e) {
						...
						case "rename":
							$("#modal_rename_items").modal("show").find("form.louis-form").data("action", t);
							break;
						case "copy_link":
							e.handleCopyLink();
							break;
						case "preview":
							...
							break;
						case "trash":
							$("#modal_trash_items").modal("show").find("form.louis-form").data("action", t);
							break;
						case "delete":
							$("#modal_delete_items").modal("show").find("form.louis-form").data("action", t);
							break;
						case "empty_trash":
							$("#modal_empty_trash").modal("show").find("form.louis-form").data("action", t);
							break;
						case "download":
							var o = LOUIS_MEDIA_URL.download,
								s = 0;
							_.each(n.a.getSelectedItems(), function(e) {
								_.includes(n.a.getConfigs().denied_download, e.mime_type) || (o += (0 === s ? "?" : "&") + "selected[" + s + "][is_folder]=" + e.is_folder + "&selected[" + s + "][id]=" + e.id, s++)
							}), o !== LOUIS_MEDIA_URL.download ? window.open(o, "_blank") : r.a.showMessage("error", LOUIS_MEDIA_CONFIG.translations.download.error, LOUIS_MEDIA_CONFIG.translations.message.error_header);
							break;
						default:
							e.processAction({
								selected: i,
				...
				value: function(e) {
					...
					$.ajax({
						url: LOUIS_MEDIA_URL.global_actions,
						type: "POST",
						data: e,
						dataType: "json",
						beforeSend: function() {
						...
						success: function(e) {
							n.a.resetPagination(), e.error ? r.a.showMessage("error", e.message, LOUIS_MEDIA_CONFIG.translations.message.error_header) : r.a.showMessage("success", e.message, LOUIS_MEDIA_CONFIG.translations.message.success_header), t && t(e)
						},
						complete: function() {
							n.a.hideAjaxLoading()
						},
				...
				value: function() {
					var e = $("#louis_media_rename_item").html(),
				...
				value: function() {
					var e = n.a.getSelectedFolder().length > 0,
						t = $("#louis_action_item").html(),
						a = 0,
						i = $(".louis-dropdown-actions .dropdown-menu");
					i.empty();
					...
					}), _.includes(LOUIS_MEDIA_CONFIG.permissions, "folders.create") || (r.file = _.reject(r.file, function(e) {
						return "make_copy" === e.action
					})), _.includes(LOUIS_MEDIA_CONFIG.permissions, "folders.edit") || (r.file = _.reject(r.file, function(e) {
						return _.includes(["rename"], e.action)
					}), r.user = _.reject(r.user, function(e) {
						return _.includes(["rename"], e.action)
					})), _.includes(LOUIS_MEDIA_CONFIG.permissions, "folders.trash") || (r.other = _.reject(r.other, function(e) {
						return _.includes(["trash", "restore"], e.action)
					})), _.includes(LOUIS_MEDIA_CONFIG.permissions, "folders.destroy") || (r.other = _.reject(r.other, function(e) {
						return _.includes(["delete"], e.action)
					})), _.includes(LOUIS_MEDIA_CONFIG.permissions, "folders.favorite") || (r.other = _.reject(r.other, function(e) {
					...
					_.each(o, function(e) {
						...
						return "preview" === e.action
					})), o.length > 0 && (_.includes(LOUIS_MEDIA_CONFIG.permissions, "files.create") || (r.file = _.reject(r.file, function(e) {
						return "make_copy" === e.action
					})), _.includes(LOUIS_MEDIA_CONFIG.permissions, "files.edit") || (r.file = _.reject(r.file, function(e) {
						return _.includes(["rename"], e.action)
					})), _.includes(LOUIS_MEDIA_CONFIG.permissions, "files.trash") || (r.other = _.reject(r.other, function(e) {
						return _.includes(["trash", "restore"], e.action)
					})), _.includes(LOUIS_MEDIA_CONFIG.permissions, "files.destroy") || (r.other = _.reject(r.other, function(e) {
						return _.includes(["delete"], e.action)
					})), _.includes(LOUIS_MEDIA_CONFIG.permissions, "files.favorite") || (r.other = _.reject(r.other, function(e) {
						return _.includes(["favorite", "remove_favorite"], e.action)
						...
						_.each(e, function(e, o) {
							...
							if (!s) {
								var l = t.replace(/__action__/gi, e.action || "").replace(/__icon__/gi, e.icon || "").replace(/__name__/gi, LOUIS_MEDIA_CONFIG.translations.actions_list[r][e.action] || e.name);
