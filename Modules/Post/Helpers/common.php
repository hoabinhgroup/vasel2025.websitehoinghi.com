...
if (!function_exists('get_featured_categories')) {
    ...
    {
        return app(CategoriesInterface::class)->getFeaturedCategories($limit, $with);
    }
}
...
if (!function_exists('get_all_categories')) {
    ...
    {
        return app(CategoriesInterface::class)->getAllCategories($condition, $with);
    }
}
...
if (!function_exists('get_popular_categories')) {
     ...
     * @return \Illuminate\Support\Collection
     */
    function get_popular_categories($limit = 10, array $with = [], array $withCount = ['posts'])
    {
        return app(CategoriesInterface::class)->getPopularCategories($limit, $with, $withCount);
    }
}
...
if (!function_exists('get_category_by_id')) {
    ...
    {
        return app(CategoriesInterface::class)->getCategoryById($id);
    }
}
