...
class InviteeRegistrationTable extends TableAbstract
{
    /**
     * @var bool
     */
    ...
    public function __construct(
        ...
        $this->repository = InviteeRegistration::query();
    ...
    public function ajax()
    {
        ...
        return $this->table($this->query())
            ...
            ->addColumn('action', function ($item) {
                ...
                return $this->getActionsButtonRow(null, 'invitee.registration.delete', $item, null, null);
            })
            ->make(true);
    }
    ...
    public function query()
    {
        ...
        $query = $model
            ->select([
                'invitee_registration.id',
                'invitee_registration.fullname',
                'invitee_registration.guest_code',
                'invitee_registration.email',
                'invitee_registration.created_at',
                'invitee_registration.payment_method',
                'invitee_registration.vpc_TransactionNo',
                'invitee_registration.status'
    ...
    public function buttons()
    {
        $buttons = [
            "export" => [
                "link" => route("invitee.registration.export"),
