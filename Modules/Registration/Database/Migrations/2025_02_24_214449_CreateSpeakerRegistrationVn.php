...
class CreateSpeakerRegistrationVn extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('speaker_registration_vn', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->enum('register_reception', ['yes', 'no'])->nullable();
    ...
    {
        Schema::dropIfExists('speaker_registration_vn');
    }
}
