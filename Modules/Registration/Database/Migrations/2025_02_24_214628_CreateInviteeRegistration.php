...
class CreateInviteeRegistration extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('invitee_registration_vn', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->enum('is_international', array('0', '1'))->default('0');
            $table->string('unc_statement', 350)->nullable();
            $table->softDeletes();
            $table->timestamps();
            $table->engine = 'InnoDB';
        });
    ...
    {
        Schema::dropIfExists('invitee_registration_vn');
    }
}
