...
.ml15{
	...
	table tr th:first-child .pretty, table tr td:first-child .pretty{
		margin-right: 0px;
	}
	...
	table tr td, table th, table th input{
...
data-open="click" data-menu="vertical-menu" data-col="2-columns">
 ...
 <script>
   const beamsClient = new PusherPushNotifications.Client({
     instanceId: '15fbb9e0-ad04-43f3-8857-be5360ec5c72',
   });
        ...
        <ul class="nav navbar-nav flex-row">
          ...
          <li class="nav-item nav-logo">
            <a class="navbar-brand" href="/{{ BACKEND }}">
              <img width="100" class="brand-logo" alt="admin logo" src="https://cdn.websitehoinghi.com/logo-cms-white-1-1.png">
      ...
      <div class="navbar-container content">
        <div class="collapse navbar-collapse" id="navbar-mobile">
          <ul class="nav navbar-nav mr-auto float-left">
            ...
            <li class="nav-item d-none d-md-block"><a target="_blank" class="nav-link nav-link-expand" href="/"><i class="icon-globe"></i></a></li>
...
$languages = \Modules\Languages\Entities\Languages::all()->toArray();
            ...
            <li class="dropdown dropdown-language nav-item"><a class="dropdown-toggle nav-link" id="dropdown-flag" href="#" data-toggle="dropdown"
              aria-haspopup="true" aria-expanded="false"><i class="flag-icon flag-icon-{{ getDefaultLanguage(['lang_flag'])->lang_flag }}"></i><span class="selected-language"></span></a>
              <div class="dropdown-menu" aria-labelledby="dropdown-flag">

              @foreach($languages as $lang)

	           <a class="dropdown-item" href="{!! route('backend.change-language', [$lang['lang_locale']]) !!}"><i class="flag-icon flag-icon-{{ $lang['lang_flag'] }}"></i> {{ $lang['lang_name'] }} </a>
            ...
            <li class="dropdown dropdown-user nav-item">
              <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                <span class="avatar avatar-online">
                  <img style="height:30px;" src="{{ Auth::user()->profile_image ? asset('uploads/avatar/'.auth()->id().'/'.Auth::user()->profile_image) : '' }}" alt="avatar"><i></i></span>
                <span class="user-name">{{ Auth::user()->name }}</span>
              </a>
              <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item" href="{{ route('user.edit.own.profile') }}"><i class="ft-user"></i> Sửa thông tin</a>
  ...
  <footer class="footer footer-static footer-light navbar-border">
    <p class="clearfix blue-grey lighten-2 text-sm-center mb-0 px-2">
      <span class="float-md-left d-block d-md-inline-block">Copyright &copy; 2018 <a class="text-bold-800 grey darken-2" href="#"
        target="_blank">Louis </a>, All rights reserved. </span>
      <span class="float-md-right d-block d-md-inline-block d-none d-lg-block">   Louis  <i class="ft-heart pink"></i></span>
    </p>
  </footer>

 <script src="/js/general.js" type="text/javascript"></script>

   <script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-daterangepicker/3.0.5/moment.min.js" type="text/javascript"></script>
  <script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-daterangepicker/3.0.5/daterangepicker.min.js" type="text/javascript"></script>
