...
<div class="content-wrapper">
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">Thêm quyền hạn</h4>
	 ...
	 @if ($errors->any())
                  ...
                  @endif
     <form class="form-horizontal" action="{!! route("cmspanel.permission.postAdd") !!}" method="post" enctype="multipart/form-data">
	{{ csrf_field() }}
	<div class="row">
	<div class="col-md-8">
		<div class="form-group">
			<label for="">Tiêu đề</label>
			<input type="text" class="form-control" id="" name="alias" placeholder="" value="">
		</div>
		<div class="form-group">
