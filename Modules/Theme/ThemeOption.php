...
*/
       ...
       // $currentLocale = is_backend() ? getBackendLangLocale() : Language::getCurrentLocaleCode();

        $currentLocale = getBaseDefaultLocaleCode('lang_locale');
        
      
		return $currentLocale ? '-' . $currentLocale : null;
