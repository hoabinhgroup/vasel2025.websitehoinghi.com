...
<div class="panel panel-info">
 	<div class="panel-heading" data-toggle="collapse" data-parent=".accordion-3" href="#a3-{{ $params['namespace'] }}">
 		<h5 class="panel-title">{{ ucfirst($params['namespace']) }}:</h5>
 	</div>
...
@endphp	 
	...
	<a onclick="importMenuNode('{{ $params['namespace'] }}','{{ $params['lang'] }}');" style="padding: 5px; color: #fff" class="btn btn-sm btn-info">
