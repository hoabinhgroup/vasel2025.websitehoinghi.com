						...
						<div class="radio-list general-information-title">
							...
							<label class="radio-inline other-specify">
								<div class="other-specify-title">
									<input name="session" value="other_session" type="radio" @if($registration->session
									!== null && !in_array($registration->session, report_sessions())) checked
									@endif>Other
								</div>
								<div class="form-group other-session">
									<input name="otherSession" id="sessionOther" class="form-control input-sm"
										...
										type="text" {{ ($registration->session == null ||
									in_array($registration->session, report_sessions())) ? 'disabled' : '' }}>
								</div>
							</label>
				...
				<div class="form-group">
					<div class="row no-gutters">
						...
						<div class="col-md-12 radio-list">
							...
							<label class="radio-inline">
								<input name="report_lang" value="vi" type="radio" @if($registration->report_lang ==
								'Tiếng Việt')
								checked @endif> Vietnamese
							</label>

							<label class="radio-inline">
								<input name="report_lang" value="en" type="radio" @if($registration->report_lang ==
								'Tiếng Anh')
				...
				<div class="form-group">
					<div class="row no-gutters">
						...
						<div class="col-md-12 radio-list">
							...
							<label class="radio-inline">
								<input name="journal_vn" value="yes" type="radio" @if($registration->journal_vn ==
								'yes')
								checked @endif> Yes
							</label>
								...
								<div class="radio-right">
									...
									<label class="radio-inline other-title-wrapper">
										<input name="title[]" value="other" type="checkbox"
											@if($registration->title_other) checked @endif>Others
					...
					<div class="form-group">
						...
						<div class="file-upload-wrapper">
							...
							<div class="file-upload-filename" id="shortCV_name"
								data-exists="{{ isset($registration->shortCV) ? '1' : '0'}}">
					...
					<div class="form-group">
						...
						<div class="file-upload-wrapper">
							<div class="file-upload-filename" id="passport_name"
								data-exists="{{ isset($registration->passport) ? '1' : '0' }}">
					...
					<div class="form-group">
						<div class="row no-gutters">
							...
							<div class="col-md-12 margin-left-20 radio-list course-list">
								...
								<label class="radio-inline">
									<input name="course" value="GI Surgery" type="radio" @if($registration->course ==
									'GI Surgery') checked @endif> GI Surgery
								</label>

								<label class="radio-inline">
									<input name="course" value="Urology" type="radio" @if($registration->course ==
									'Urology') checked @endif> Urology
								</label>
								<label class="radio-inline">
					...
					<div class="form-group">
						<div class="row no-gutters">
							...
							<div class="register-course">
								@foreach (courses_en() as $course_name)
								<label class="radio-inline">
