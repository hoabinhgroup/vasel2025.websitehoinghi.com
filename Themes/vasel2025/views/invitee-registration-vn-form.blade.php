	...
	<div class="contents" id="">
		<div class="sub-conbox inner-layer">
			...
			<form action="{{ route('invitee.registration.vn.submit') }}" id="payment-registration"
							...
							<div class="radio-list-title">
								<div class="radio-right">
									...
									<label class="radio-inline">
										<input name="title[]" value="{{ $title }}" type="checkbox" @if(in_array($title,
											$registration_title)) checked @endif>{{ $title }}.
									</label>
									@endforeach
									...
									<label class="radio-inline other-title-wrapper">
										...
										<input name="titleOther" id="titleOther" class="form-control input-sm"
											value="{{ $registration->title_other ?? '' }}" type="text" {{
											$registration->title_other == null ? 'disabled' : '' }}>
									</label>
								</div>
							</div>
						</div>
				...
				<div class="form-group">
					<div class="row no-gutters">
						...
						<div class="col-md-12 margin-left-20 radio-list">
							...
							<label class="radio-inline">
								<input name="gender" value="nam" type="radio" @if($registration->gender == 'nam')
								checked
								@endif>
								Nam
							</label>
					...
					<div class="form-group">
						<div class="row no-gutters">
							...
							<div class="col-md-12 margin-left-20 radio-list course-list">
								...
								<label class="radio-inline">
									<input name="course" value="Tiêu hóa" type="radio" @if($registration->course ==
									'Tiêu hóa') checked @endif> Tiêu hóa
								</label>

								<label class="radio-inline">
									<input name="course" value="Tiết niệu" type="radio" @if($registration->course ==
									'Tiết niệu') checked @endif> Tiết niệu
								</label>
								<label class="radio-inline">
								...
								<label class="radio-inline course-other">
									<input name="course" value="other_course" type="radio" @if($registration->course !==
									null && !in_array($registration->course, array_course())) checked @endif>
									Khác
				...
				<div class="form-group">
					<div class="row no-gutters">
						...
						<div class="col-md-12 margin-left-20 radio-list">
							...
							<label class="radio-inline">
								<input name="galadinner" value="yes" type="radio" @if($registration->galadinner ==
								'yes') checked @endif> Có
							</label>
						...
						<div class="col-md-12 margin-left-20 radio-list">
							...
							<label class="radio-inline">
								<input name="form_invitation" value="hard" type="radio"
									@if($registration->form_invitation == 'hard') checked @endif> Bản cứng (Vui lòng
								kiểm
								tra lại
								địa
						...
						<div class="col-md-12 margin-left-20 radio-list">
							...
							<label class="radio-inline">
								<input name="form_certificate" value="hard" type="radio"
									@if($registration->form_certificate == 'hard') checked @endif> Bản cứng (Vui lòng
								kiểm
								tra
								lại
								địa
				...
				<div class="form-group">
					<div class="row no-gutters">
						...
						<div class="col-md-12 margin-left-20 radio-list">
							...
							<label class="radio-inline">
								<input name="payment_form" value="advance" type="radio" @if($registration->payment_form
								== 'advance') checked @endif> Đóng phí trước hội nghị
							</label>


							<label class="radio-inline">
								<input name="payment_form" value="onsite" type="radio" @if($registration->payment_form
								== 'onsite') checked @endif> Đóng trực tiếp tại hội
								nghị
							</label>
						...
						<div class="col-md-12">
							<label for="wire_transfer" class="radio-inline">
								<input id="wire_transfer" class="payment_method unc_statement" name="payment_method"
									...
									@if($registration->payment_method == PaymentMethodEnum::BANK_TRANSFER) checked
								@endif>
							...
							<div class="wire_transfer_description">
								...
								Nội dung chuyển khoản: HỌ TÊN + ĐƠN VỊ CÔNG TÁC + SĐT + ĐÓNG PHÍ THAM DỰ VASEL 2025
								<br />
				...
				<div id="unc_section" class="form-group" @if ($registration->payment_method ==
					PaymentMethodEnum::BANK_TRANSFER) style="display:block;" @endif>
					<div class="row">
