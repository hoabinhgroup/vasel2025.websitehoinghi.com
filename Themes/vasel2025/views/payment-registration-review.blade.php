...
@section('content')
	...
	<style>
		...
		#conference-fee-table thead th,
		#conference-fee-table tr td {
			...
			<div class="s-12 padding-2x background-white text-center">
				...
				<div class="form-group">
					...
					<div class="registration_section form-group">
						<a href="/payment-registration-page"
							class="s-12 m-9 l-2 center button text-size-20 text-white background-green">BACK</a>
						<a href="{{ route('payment.registration.submit') }}"
							class="s-12 m-9 l-2 center button text-size-20 text-white background-green">SUBMIT</a>
